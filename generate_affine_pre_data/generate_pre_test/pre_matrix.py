...
for x in range(1024,1150,128):
    for y in range(1024,1150,128):
...
np.savez("D:\\ProgramData_second\\generate_affine_pre_data\\data\\generated_npz_image\\pre_displacement_4_point.npz",
         fixed=fixed,
         moving=moving,
