...
for x in range(64,image_cv2_band7.shape[0]-64,128):
    for y in range(64,image_cv2_band7.shape[1]-64,128):
        ...
        cv2.imwrite("D:\\Second_paper_VAE_CNN\\Affine_image\\fixed_image\\"+"%03d"%x+"_"+"%03d"%y+".jpg",sub_fixed)
        cv2.imwrite("D:\\Second_paper_VAE_CNN\\Affine_image\\moved_image\\" + "%03d"%x + "_" + "%03d"%y + ".jpg", sub_moved)
        ...
        cv2.imwrite("D:\\Second_paper_VAE_CNN\\Affine_image\\moving_image\\" + "%03d"%x + "_" + "%03d"%y + ".jpg", sub_moving)
